module.exports.config = {
	...
	hasPermssion: 2,
	credits: "SHAAN KHAN",
	description: "THIS BOT IS MR SHAAN KHAN",
  ...
  switch (type) {
        case "pending": {
          switch (body) {
   			...
   			api.sendMessage(`𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐡𝐚𝐚𝐧 𝐊𝐡𝐚𝐧 𝐁𝐨𝐭 😇👈
=𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹●============================================================● 𝐀𝐩𝐏 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 =𝐎𝐰𝐧𝐞𝐫 ➻    ?𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹\n${idBox}`, threadID, () => {
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓?𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 😇●============================================================● 𝐀𝐩𝐏 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 𝐎𝐰𝐧𝐞𝐫 ➻    ?𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹 \n✧●============================================================●\n●====== 𝐀𝐁𝐁  𝐊𝐀𝐑𝐎  𝐌𝐄𝐒𝐓𝐈 =====●\n●============================================================●\n=𝐎𝐰𝐧𝐞𝐫 ➻    ?𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹\n●============================================================●\n𝐀𝐩𝐏𝐤𝐀 𝐏𝐲𝐑𝐚 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹 \n●============================================================●\n𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 𝐥𝐢𝐧𝐤 😊👈 𝐒𝐡𝐚𝐚𝐧 :- ☞ \nhttps://www.facebook.com/profile.php?id=61564921530129/n●============================================================●\n𝐊𝐢𝐒𝐢 𝐁𝐡𝐈 𝐓𝐚𝐇𝐚𝐑𝐚 𝐊𝐢 𝐇𝐞𝐋𝐩 𝐋𝐚𝐍𝐢 𝐇𝐨 𝐀𝐛𝐇𝐢 𝐌𝐞𝐒𝐒𝐠 𝐊𝐚𝐑𝐞 𝐎𝐰𝐧𝐞𝐫 ➻    ?𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊 🌹●============================================================● 👉 [+92 3368783346]", idBox, (error, info) => {
